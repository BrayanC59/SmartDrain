      ...
      >
        <div className="text-center mb-8">
          <div className="inline-flex justify-center items-center w-14 h-14 rounded-full bg-blue-100 dark:bg-blue-900/30 mb-4">
            <UserPlus className="h-7 w-7 text-primary-600 dark:text-blue-400" />
          </div>
          <h2 className="text-2xl font-bold font-heading text-gray-900 dark:text-white">Únete a la red cívica</h2>
          <p className="text-gray-500 dark:text-gray-400 mt-2">Crea tu cuenta para reportar problemas de drenaje</p>
        </div>

        <form onSubmit={manejarEnvio} className="space-y-5">
           <div>
            <label className="block text-sm font-medium mb-1.5 text-gray-700 dark:text-gray-300">Nombre completo</label>
            <input 
              type="text" 
              required
              value={nombre}
        ...
        <p className="text-center mt-6 text-sm text-gray-600 dark:text-gray-400">
          ¿Ya tienes cuenta? <Link to="/acceso" className="text-primary-600 dark:text-blue-400 font-medium hover:underline">Inicia sesión</Link>
        </p>
      </motion.div>
    </div>
  );
